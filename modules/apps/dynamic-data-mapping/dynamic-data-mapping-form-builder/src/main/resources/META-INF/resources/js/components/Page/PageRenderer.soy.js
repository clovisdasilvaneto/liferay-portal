...
goog.loadModule(function(exports) {
	...
	function $render(opt_data, opt_ijData, opt_ijData_deprecated) {
		...
		var contentRenderer__soy1233 =
			($$temp = page.contentRenderer) == null ? paginationMode : $$temp;
		soy.$$getDelegateFn(
			soy.$$getDelTemplateId('PageRenderer.container.idom'),
			contentRenderer__soy1233,
			false
	...
	function $fieldEmpty(opt_data, opt_ijData, opt_ijData_deprecated) {
		opt_ijData = opt_ijData_deprecated || opt_ijData;
		/** @type {number} */
		var size = soy.asserts.assertType(
			goog.isNumber(opt_data.size),
			'size',
			opt_data.size,
			'number'
		);
		...
		/** @type {boolean|null|undefined} */
		var isRow = soy.asserts.assertType(
			opt_data.isRow == null ||
				(goog.isBoolean(opt_data.isRow) ||
					opt_data.isRow === 1 ||
					opt_data.isRow === 0),
			'isRow',
			opt_data.isRow,
	 ...
	 * @suppress {checkTypes}
	 */
	function __deltemplate_s1294_e5792ebc(
		opt_data,
		opt_ijData,
	...
	if (goog.DEBUG) {
		__deltemplate_s1294_e5792ebc.soyTemplateName =
			'PageRenderer.__deltemplate_s1294_e5792ebc';
	}
	soy.$$registerDelegateFn(
		soy.$$getDelTemplateId('PageRenderer.RegisterFieldType.idom'),
		'',
		0,
		__deltemplate_s1294_e5792ebc
	);
	 ...
	 * @suppress {checkTypes}
	 */
	function __deltemplate_s1302_b2357b30(
		opt_data,
		opt_ijData,
		opt_ijData_deprecated
	) {
	...
	if (goog.DEBUG) {
		__deltemplate_s1302_b2357b30.soyTemplateName =
			'PageRenderer.__deltemplate_s1302_b2357b30';
	}
	soy.$$registerDelegateFn(
		soy.$$getDelTemplateId('PageRenderer.PageHeader.idom'),
		'',
		0,
		__deltemplate_s1302_b2357b30
	);
