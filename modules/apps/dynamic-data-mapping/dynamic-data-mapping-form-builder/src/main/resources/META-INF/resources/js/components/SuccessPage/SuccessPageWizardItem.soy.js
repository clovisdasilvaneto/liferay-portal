...
goog.loadModule(function(exports) {
	 ...
	 * @suppress {checkTypes}
	 */
	function __deltemplate_s4294_3b26c598(
		opt_data,
		opt_ijData,
	...
	if (goog.DEBUG) {
		__deltemplate_s4294_3b26c598.soyTemplateName =
			'SuccessPageWizardItem.__deltemplate_s4294_3b26c598';
	}
	soy.$$registerDelegateFn(
		soy.$$getDelTemplateId('FormRenderer.WizardItem.idom'),
		'success',
		0,
		__deltemplate_s4294_3b26c598
	);
