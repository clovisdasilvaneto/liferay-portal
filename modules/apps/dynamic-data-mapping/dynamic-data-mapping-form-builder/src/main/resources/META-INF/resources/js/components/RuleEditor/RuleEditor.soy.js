...
goog.loadModule(function(exports) {
	...
	function $render(opt_data, opt_ijData, opt_ijData_deprecated) {
		...
		var actions = soy.asserts.assertType(
			goog.isArray(opt_data.actions),
			'actions',
			opt_data.actions,
			'!Array<{action: (!goog.soy.data.SanitizedContent|string), calculatorFields: !Array<{label: (!goog.soy.data.SanitizedContent|string), name: (!goog.soy.data.SanitizedContent|string), options: !Array<{label: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, type: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, expression: (!goog.soy.data.SanitizedContent|string), hasRequiredInputs: boolean, inputs: !Array<{fieldOptions: !Array<{label: (!goog.soy.data.SanitizedContent|string), name: (!goog.soy.data.SanitizedContent|string), options: !Array<{label: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, type: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, label: (!goog.soy.data.SanitizedContent|string), name: (!goog.soy.data.SanitizedContent|string), required: boolean, type: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, label: (!goog.soy.data.SanitizedContent|string), outputs: !Array<{fieldOptions: !Array<{label: (!goog.soy.data.SanitizedContent|string), name: (!goog.soy.data.SanitizedContent|string), options: !Array<{label: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, type: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, name: (!goog.soy.data.SanitizedContent|string), type: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, target: (!goog.soy.data.SanitizedContent|string)}>'
		);
		/** @type {!Array<{name: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>} */
		var actionTypes = soy.asserts.assertType(
			goog.isArray(opt_data.actionTypes),
			'actionTypes',
			opt_data.actionTypes,
			'!Array<{name: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>'
		);
		...
		var actionsFieldOptions = soy.asserts.assertType(
			goog.isArray(opt_data.actionsFieldOptions),
			'actionsFieldOptions',
			opt_data.actionsFieldOptions,
			'!Array<{label: (!goog.soy.data.SanitizedContent|string), name: (!goog.soy.data.SanitizedContent|string), options: !Array<{label: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, type: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>'
		);
		...
		var calculatorFunctions = soy.asserts.assertType(
			goog.isArray(opt_data.calculatorFunctions),
			'calculatorFunctions',
			opt_data.calculatorFunctions,
			'!Array<{label: (!goog.soy.data.SanitizedContent|string), tooltip: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>'
		);
		/** @type {!Array<{label: (!goog.soy.data.SanitizedContent|string), name: (!goog.soy.data.SanitizedContent|string), options: !Array<{label: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, type: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>} */
		var calculatorResultOptions = soy.asserts.assertType(
			goog.isArray(opt_data.calculatorResultOptions),
			'calculatorResultOptions',
			opt_data.calculatorResultOptions,
			'!Array<{label: (!goog.soy.data.SanitizedContent|string), name: (!goog.soy.data.SanitizedContent|string), options: !Array<{label: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, type: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>'
		);
		/** @type {!Array<{binaryOperator: boolean, firstOperandOptions: !Array<{label: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, operands: !Array<{dataType: (!goog.soy.data.SanitizedContent|string), label: (!goog.soy.data.SanitizedContent|string), type: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, operator: (!goog.soy.data.SanitizedContent|string), operators: !Array<{name: (!goog.soy.data.SanitizedContent|string), parameterTypes: !Array<!goog.soy.data.SanitizedContent|string>, returnType: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>}>} */
		var conditions = soy.asserts.assertType(
			goog.isArray(opt_data.conditions),
			'conditions',
			opt_data.conditions,
			'!Array<{binaryOperator: boolean, firstOperandOptions: !Array<{label: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, operands: !Array<{dataType: (!goog.soy.data.SanitizedContent|string), label: (!goog.soy.data.SanitizedContent|string), type: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, operator: (!goog.soy.data.SanitizedContent|string), operators: !Array<{name: (!goog.soy.data.SanitizedContent|string), parameterTypes: !Array<!goog.soy.data.SanitizedContent|string>, returnType: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>}>'
		);
		/** @type {!Array<{label: (!goog.soy.data.SanitizedContent|string), name: (!goog.soy.data.SanitizedContent|string), options: !Array<{label: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, type: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>} */
		var conditionsFieldOptions = soy.asserts.assertType(
			goog.isArray(opt_data.conditionsFieldOptions),
			'conditionsFieldOptions',
			opt_data.conditionsFieldOptions,
			'!Array<{label: (!goog.soy.data.SanitizedContent|string), name: (!goog.soy.data.SanitizedContent|string), options: !Array<{label: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, type: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>'
		);
		/** @type {!Array<{id: (!goog.soy.data.SanitizedContent|string), name: (!goog.soy.data.SanitizedContent|string)}>|null|undefined} */
		var dataProvider = soy.asserts.assertType(
			opt_data.dataProvider == null ||
				goog.isArray(opt_data.dataProvider),
			'dataProvider',
			opt_data.dataProvider,
			'!Array<{id: (!goog.soy.data.SanitizedContent|string), name: (!goog.soy.data.SanitizedContent|string)}>|null|undefined'
		);
		...
		var fixedOptions = soy.asserts.assertType(
			goog.isArray(opt_data.fixedOptions),
			'fixedOptions',
			opt_data.fixedOptions,
			'!Array<{name: (!goog.soy.data.SanitizedContent|string), options: !Array<{label: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, type: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>'
		);
		/** @type {boolean} */
		var invalidRule = soy.asserts.assertType(
			goog.isBoolean(opt_data.invalidRule) ||
				opt_data.invalidRule === 1 ||
				opt_data.invalidRule === 0,
			'invalidRule',
			opt_data.invalidRule,
			'boolean'
		);
		/** @type {!goog.soy.data.SanitizedContent|string} */
		var logicalOperator = soy.asserts.assertType(
			goog.isString(opt_data.logicalOperator) ||
				opt_data.logicalOperator instanceof
					goog.soy.data.SanitizedContent,
			'logicalOperator',
			opt_data.logicalOperator,
		...
		var pageOptions = soy.asserts.assertType(
			goog.isArray(opt_data.pageOptions),
			'pageOptions',
			opt_data.pageOptions,
			'!Array<{label: (!goog.soy.data.SanitizedContent|string), name: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>'
		);
		/** @type {boolean} */
		var readOnly = soy.asserts.assertType(
			goog.isBoolean(opt_data.readOnly) ||
				opt_data.readOnly === 1 ||
				opt_data.readOnly === 0,
			'readOnly',
			opt_data.readOnly,
		...
		/** @type {*|null|undefined} */
		var _handleDataProviderInputEdited =
			opt_data._handleDataProviderInputEdited;
		/** @type {*|null|undefined} */
		var _handleDataProviderOutputEdited =
			opt_data._handleDataProviderOutputEdited;
		/** @type {*|null|undefined} */
		...
		/** @type {*|null|undefined} */
		var _handleFirstOperandFieldEdited =
			opt_data._handleFirstOperandFieldEdited;
		/** @type {*|null|undefined} */
		var _handleLogicalOperationChange =
			opt_data._handleLogicalOperationChange;
		/** @type {*|null|undefined} */
		var _handleOperatorEdited = opt_data._handleOperatorEdited;
		/** @type {*|null|undefined} */
		var _handleRuleAdded = opt_data._handleRuleAdded;
		/** @type {*|null|undefined} */
		var _handleSecondOperandFieldEdited =
			opt_data._handleSecondOperandFieldEdited;
		/** @type {*|null|undefined} */
		var _handleSecondOperandTypeEdited =
			opt_data._handleSecondOperandTypeEdited;
		/** @type {*|null|undefined} */
		var _handleSecondOperandValueEdited =
			opt_data._handleSecondOperandValueEdited;
		/** @type {*|null|undefined} */
		...
		var roles = soy.asserts.assertType(
			opt_data.roles == null || goog.isArray(opt_data.roles),
			'roles',
			opt_data.roles,
			'!Array<{label: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>|null|undefined'
		);
		...
		/** @desc  */
		var MSG_EXTERNAL_7798565773259526400 = Liferay.Language.get(
			'condition'
		);
		...
		incrementalDom.text(
			goog.string.unescapeEntities(MSG_EXTERNAL_4769335989898602524)
		);
		...
		incrementalDom.elementOpenEnd();
		/** @desc  */
		var MSG_EXTERNAL_1948122749534399739 = Liferay.Language.get(
			'define-condition-and-action-to-change-fields-and-elements-on-the-form'
		);
		incrementalDom.text(
			goog.string.unescapeEntities(MSG_EXTERNAL_1948122749534399739)
		);
		incrementalDom.elementClose('h4');
		incrementalDom.elementOpenStart('ul');
		incrementalDom.attr(
			'class',
			'liferay-ddm-form-builder-rule-condition-list liferay-ddm-form-rule-builder-timeline timeline ' +
				(conditions.length > 1 ? 'can-remove-item' : '')
		);
		incrementalDom.elementOpenEnd();
		var enableLogicalOperator__soy2115 =
			conditions.length > 1 ? true : false;
		var param2118 = function() {
			$renderConditionLogicalOperatorDropdown(
				{
					_handleLogicalOperationChange: _handleLogicalOperationChange,
					enableLogicalOperator: enableLogicalOperator__soy2115,
		...
		$renderHeader(
			{extraContent: param2118, title: '' + msg_19885__soy19886},
			null,
			opt_ijData
		);
		...
		for (
			var condition2158Index = 0;
			condition2158Index < condition2158ListLen;
			condition2158Index++
		) {
			var condition2158Data = condition2158List[condition2158Index];
			$renderCondition(
				{
					_handleDeleteCondition: _handleDeleteCondition,
					_handleFirstOperandFieldEdited: _handleFirstOperandFieldEdited,
					_handleOperatorEdited: _handleOperatorEdited,
					_handleSecondOperandFieldEdited: _handleSecondOperandFieldEdited,
					_handleSecondOperandTypeEdited: _handleSecondOperandTypeEdited,
					_handleSecondOperandValueEdited: _handleSecondOperandValueEdited,
					binaryOperator: condition2158Data.binaryOperator,
					fieldOptions: conditionsFieldOptions,
					firstOperandType: condition2158Data.operands[0].type,
					firstOperandOptions: condition2158Data.firstOperandOptions,
					firstOperandValueSelected:
						condition2158Data.operands[0].value,
					fixedOptions: fixedOptions,
					index: condition2158Index,
					logicalOperator: logicalOperator,
					operators: condition2158Data.operators,
					readOnly: readOnly,
					roles: roles,
					secondOperandDataType:
						condition2158Data.operands[1] != null
							? condition2158Data.operands[1].dataType
							: '',
					secondOperandFieldName: '',
					secondOperandType:
						condition2158Data.operands[1] != null
							? condition2158Data.operands[1].type
							: '',
					secondOperandValue:
						condition2158Data.operands[1] != null
							? condition2158Data.operands[1].value
							: '',
					selectedOperator: condition2158Data.operator,
					spritemap: spritemap
				},
				null,
				opt_ijData
		...
		$renderAddItemButton(
			{
				_handleItemAdded: _handleConditionAdded,
				spritemap: spritemap,
				type: 'addConditionButton'
			},
			null,
			opt_ijData
		);
		...
		incrementalDom.attr(
			'class',
			'action-list liferay-ddm-form-builder-rule-action-list liferay-ddm-form-rule-builder-timeline timeline ' +
				(actions.length > 1 ? 'can-remove-item' : '')
		);
		incrementalDom.elementOpenEnd();
		...
		for (
			var action2200Index = 0;
			action2200Index < action2200ListLen;
			action2200Index++
		) {
			var action2200Data = action2200List[action2200Index];
			$renderAction(
				{
					_handleActionSelection: _handleActionSelection,
					_handleDataProviderInputEdited: _handleDataProviderInputEdited,
					_handleDataProviderOutputEdited: _handleDataProviderOutputEdited,
					_handleDeleteAction: _handleDeleteAction,
					_handleEditExpression: _handleEditExpression,
					_handleTargetSelection: _handleTargetSelection,
					actionInputs: action2200Data.inputs,
					actionOutputs: action2200Data.outputs,
					actionSelected: action2200Data.action,
					actionExpression: action2200Data.expression,
					actionTypes: actionTypes,
					calculatorFunctions: calculatorFunctions,
					calculatorFields: action2200Data.calculatorFields,
					calculatorResultOptions: calculatorResultOptions,
					dataProvider: dataProvider,
					fieldOptions: actionsFieldOptions,
					hasRequiredInputs: action2200Data.hasRequiredInputs,
					index: action2200Index,
					pageOptions: pageOptions,
					spritemap: spritemap,
					targetSelected: action2200Data.target
				},
				null,
				opt_ijData
			);
		...
		$renderAddItemButton(
			{
				_handleItemAdded: _handleActionAdded,
				spritemap: spritemap,
		...
		$renderModal(
			{
				_handleModalButtonClicked: _handleModalButtonClicked,
				question: '' + msg_19891__soy19892,
				spritemap: spritemap,
				title: '' + msg_19894__soy19895,
				type: 'Condition'
			},
			null,
			opt_ijData
		...
		$renderModal(
			{
				_handleModalButtonClicked: _handleModalButtonClicked,
				question: '' + msg_19897__soy19898,
				spritemap: spritemap,
				title: '' + msg_19900__soy19901,
				type: 'Action'
			},
			null,
			opt_ijData
		...
		$templateAlias1(
			{
				events: {click: _handleRuleAdded},
				disabled: invalidRule,
				label: '' + msg_19903__soy19904,
				ref: 'save',
				spritemap: spritemap,
				style: 'primary'
			},
		...
		$templateAlias1(
			{
				events: {click: _handleCancelRule},
				label: '' + msg_19906__soy19907,
				ref: 'cancel',
				spritemap: spritemap,
				style: 'secondary'
			},
	...
	function $renderModal(opt_data, opt_ijData, opt_ijData_deprecated) {
		opt_ijData = opt_ijData_deprecated || opt_ijData;
		/** @type {!goog.soy.data.SanitizedContent|string} */
		var question = soy.asserts.assertType(
			goog.isString(opt_data.question) ||
				opt_data.question instanceof goog.soy.data.SanitizedContent,
			'question',
			opt_data.question,
			'!goog.soy.data.SanitizedContent|string'
		);
		...
		/** @type {!goog.soy.data.SanitizedContent|string} */
		var type = soy.asserts.assertType(
			goog.isString(opt_data.type) ||
				opt_data.type instanceof goog.soy.data.SanitizedContent,
			'type',
			opt_data.type,
			'!goog.soy.data.SanitizedContent|string'
		);
		...
		$templateAlias2(
			{
				body: param2289,
				events: {clickButton: _handleModalButtonClicked},
				footerButtons: [
					{
						alignment: 'right',
						label: dismissLabel__soy2281,
						style: 'primary',
						type: 'close'
					},
					{
						alignment: 'right',
						label: deleteLabel__soy2274,
						style: 'primary',
						type: 'button'
					}
				],
				ref: 'confirmationModal' + type,
				size: 'sm',
				spritemap: spritemap,
				title: title
			},
	...
	function $renderAction(opt_data, opt_ijData, opt_ijData_deprecated) {
		...
		/** @type {!Array<{label: (!goog.soy.data.SanitizedContent|string), name: (!goog.soy.data.SanitizedContent|string), options: !Array<{label: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, type: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>} */
		var calculatorFields = soy.asserts.assertType(
			goog.isArray(opt_data.calculatorFields),
			'calculatorFields',
			opt_data.calculatorFields,
			'!Array<{label: (!goog.soy.data.SanitizedContent|string), name: (!goog.soy.data.SanitizedContent|string), options: !Array<{label: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, type: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>'
		);
		/** @type {!Array<{label: (!goog.soy.data.SanitizedContent|string), tooltip: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>} */
		var calculatorFunctions = soy.asserts.assertType(
		...
		/** @type {!Array<{label: (!goog.soy.data.SanitizedContent|string), name: (!goog.soy.data.SanitizedContent|string), options: !Array<{label: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, type: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>} */
		var fieldOptions = soy.asserts.assertType(
			goog.isArray(opt_data.fieldOptions),
			'fieldOptions',
			opt_data.fieldOptions,
			'!Array<{label: (!goog.soy.data.SanitizedContent|string), name: (!goog.soy.data.SanitizedContent|string), options: !Array<{label: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, type: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>'
		);
		/** @type {number} */
		...
		var actionExpression = soy.asserts.assertType(
			opt_data.actionExpression == null ||
				(goog.isString(opt_data.actionExpression) ||
					opt_data.actionExpression instanceof
						goog.soy.data.SanitizedContent),
			'actionExpression',
			opt_data.actionExpression,
		...
		var actionInputs = soy.asserts.assertType(
			opt_data.actionInputs == null ||
				goog.isArray(opt_data.actionInputs),
			'actionInputs',
			opt_data.actionInputs,
			'!Array<{fieldOptions: !Array<{label: (!goog.soy.data.SanitizedContent|string), name: (!goog.soy.data.SanitizedContent|string), options: !Array<{label: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, type: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, label: (!goog.soy.data.SanitizedContent|string), name: (!goog.soy.data.SanitizedContent|string), required: boolean, type: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>|null|undefined'
		);
		...
		var actionOutputs = soy.asserts.assertType(
			opt_data.actionOutputs == null ||
				goog.isArray(opt_data.actionOutputs),
			'actionOutputs',
			opt_data.actionOutputs,
			'!Array<{fieldOptions: !Array<{label: (!goog.soy.data.SanitizedContent|string), name: (!goog.soy.data.SanitizedContent|string), options: !Array<{label: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, type: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, name: (!goog.soy.data.SanitizedContent|string), type: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>|null|undefined'
		);
		/** @type {!goog.soy.data.SanitizedContent|null|string|undefined} */
		var actionSelected = soy.asserts.assertType(
			opt_data.actionSelected == null ||
				(goog.isString(opt_data.actionSelected) ||
					opt_data.actionSelected instanceof
						goog.soy.data.SanitizedContent),
			'actionSelected',
			opt_data.actionSelected,
			'!goog.soy.data.SanitizedContent|null|string|undefined'
		);
		/** @type {!Array<{id: (!goog.soy.data.SanitizedContent|string), name: (!goog.soy.data.SanitizedContent|string)}>|null|undefined} */
		var dataProvider = soy.asserts.assertType(
		...
		/** @type {!goog.soy.data.SanitizedContent|null|string|undefined} */
		var targetSelected = soy.asserts.assertType(
			opt_data.targetSelected == null ||
				(goog.isString(opt_data.targetSelected) ||
					opt_data.targetSelected instanceof
						goog.soy.data.SanitizedContent),
			'targetSelected',
			opt_data.targetSelected,
			'!goog.soy.data.SanitizedContent|null|string|undefined'
		);
		/** @type {boolean|null|undefined} */
		var hasRequiredInputs = soy.asserts.assertType(
			opt_data.hasRequiredInputs == null ||
				(goog.isBoolean(opt_data.hasRequiredInputs) ||
					opt_data.hasRequiredInputs === 1 ||
					opt_data.hasRequiredInputs === 0),
			'hasRequiredInputs',
			opt_data.hasRequiredInputs,
			'boolean|null|undefined'
		);
		var msg_19915__soy19916 = '';
		/** @desc  */
		var MSG_EXTERNAL_1961977818876868209 = Liferay.Language.get(
			'choose-an-option'
		);
		...
		incrementalDom.attr(
			'class',
			'action form-builder-rule-action-container-' +
				index +
				' timeline-item'
		);
		incrementalDom.elementOpenEnd();
		...
		incrementalDom.attr(
			'class',
			'form-group-item form-group-item-label form-group-item-shrink'
		);
		incrementalDom.elementOpenEnd();
		incrementalDom.elementOpen('h4');
		...
		incrementalDom.text(
			goog.string.unescapeEntities(MSG_EXTERNAL_363699841498386168)
		);
		...
		soy.$$getDelegateFn(
			...
			'select',
			false
		)({events: {fieldEdited: _handleActionSelection}, options: actionTypes, placeholder: '' + msg_19915__soy19916, ref: 'action' + index, spritemap: spritemap, value: [actionSelected]}, null, opt_ijData);
		incrementalDom.elementClose('div');
		var showTargetDefault__soy2347 =
			actionSelected &&
			(actionSelected == 'show' ||
				actionSelected == 'enable' ||
				actionSelected == 'require');
		var showTargetAutofill__soy2349 =
			actionSelected && actionSelected == 'auto-fill';
		var showTargetCalculator__soy2351 =
			actionSelected && actionSelected == 'calculate';
		var showTargetJumpToPage__soy2353 =
			actionSelected && actionSelected == 'jump-to-page';
		var showLabel__soy2355 =
			showTargetAutofill__soy2349 || showTargetCalculator__soy2351;
		incrementalDom.elementOpenStart('div');
		incrementalDom.attr(
			'class',
			'form-group-item form-group-item-label form-group-item-shrink ' +
				(!showLabel__soy2355 ? 'hide' : '') +
				' target-message-' +
				index
		);
		incrementalDom.elementOpenEnd();
		...
		if (showTargetAutofill__soy2349) {
			...
			incrementalDom.elementOpenEnd();
			/** @desc  */
			var MSG_EXTERNAL_8534686501757254979 = Liferay.Language.get(
				'from-data-provider'
			);
			incrementalDom.text(
				goog.string.unescapeEntities(MSG_EXTERNAL_8534686501757254979)
			);
			incrementalDom.elementClose('span');
			...
			incrementalDom.elementOpenEnd();
			/** @desc  */
			var MSG_EXTERNAL_8489746971914331803 = Liferay.Language.get(
				'choose-a-field-to-show-the-result'
			);
			incrementalDom.text(
				goog.string.unescapeEntities(MSG_EXTERNAL_8489746971914331803)
			);
			incrementalDom.elementClose('span');
		}
		incrementalDom.elementClose('span');
		...
		incrementalDom.elementClose('div');
		if (
			showTargetDefault__soy2347 ||
			showTargetAutofill__soy2349 ||
			showTargetCalculator__soy2351 ||
			showTargetJumpToPage__soy2353
		) {
			var msg_19918__soy19919 = '';
			/** @desc  */
			var MSG_EXTERNAL_1961977818876868209$$1 = Liferay.Language.get(
				'choose-an-option'
			);
			msg_19918__soy19919 += MSG_EXTERNAL_1961977818876868209$$1;
			var options__soy2380 = showTargetAutofill__soy2349
				? dataProvider
				: showTargetDefault__soy2347
				? fieldOptions
				: showTargetJumpToPage__soy2353
				...
				? calculatorResultOptions
				: [];
			var ref__soy2382 = showTargetCalculator__soy2351
				? 'calculatorResult'
				: 'actionTarget';
			$renderActionTarget(
				{
					_handleTargetSelection: _handleTargetSelection,
					index: index,
					options: options__soy2380,
					placeholder: '' + msg_19918__soy19919,
					ref: ref__soy2382 + index,
					spritemap: spritemap,
		...
		if (showTargetCalculator__soy2351 && targetSelected) {
			$templateAlias3(
				{
					events: {editExpression: _handleEditExpression},
					expression: actionExpression,
					fields: calculatorFields,
					functions: calculatorFunctions,
					index: index,
					resultSelected: targetSelected,
					spritemap: spritemap
				},
				null,
				opt_ijData
		...
		$templateAlias1(
			{
				events: {click: _handleDeleteAction},
				data: {index: index},
				icon: 'trash',
				monospaced: true,
				ref: 'trashButtonAction' + index,
				size: 'sm',
				spritemap: spritemap,
				style: 'secondary'
			},
	...
	function $renderActionTarget(opt_data, opt_ijData, opt_ijData_deprecated) {
		...
		/** @type {!goog.soy.data.SanitizedContent|string} */
		var ref = soy.asserts.assertType(
			goog.isString(opt_data.ref) ||
				opt_data.ref instanceof goog.soy.data.SanitizedContent,
			'ref',
			opt_data.ref,
			'!goog.soy.data.SanitizedContent|string'
		);
		...
		/** @type {!goog.soy.data.SanitizedContent|null|string|undefined} */
		var value = soy.asserts.assertType(
			opt_data.value == null ||
				(goog.isString(opt_data.value) ||
					opt_data.value instanceof goog.soy.data.SanitizedContent),
			'value',
			opt_data.value,
			'!goog.soy.data.SanitizedContent|null|string|undefined'
		);
		...
		soy.$$getDelegateFn(
			...
			'select',
			false
		)({events: {fieldEdited: _handleTargetSelection}, options: options, placeholder: placeholder, ref: ref, spritemap: spritemap, value: [value]}, null, opt_ijData);
		incrementalDom.elementClose('div');
	}
	...
	function $renderCondition(opt_data, opt_ijData, opt_ijData_deprecated) {
		opt_ijData = opt_ijData_deprecated || opt_ijData;
		/** @type {boolean} */
		var binaryOperator = soy.asserts.assertType(
			goog.isBoolean(opt_data.binaryOperator) ||
				opt_data.binaryOperator === 1 ||
				opt_data.binaryOperator === 0,
			'binaryOperator',
			opt_data.binaryOperator,
			'boolean'
		);
		/** @type {!Array<{label: (!goog.soy.data.SanitizedContent|string), name: (!goog.soy.data.SanitizedContent|string), options: !Array<{label: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>, type: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>} */
		var fieldOptions = soy.asserts.assertType(
		...
		var _handleSecondOperandValueEdited =
			opt_data._handleSecondOperandValueEdited;
		/** @type {!goog.soy.data.SanitizedContent|null|string|undefined} */
		var firstOperandType = soy.asserts.assertType(
			opt_data.firstOperandType == null ||
				(goog.isString(opt_data.firstOperandType) ||
					opt_data.firstOperandType instanceof
						goog.soy.data.SanitizedContent),
			'firstOperandType',
			opt_data.firstOperandType,
			'!goog.soy.data.SanitizedContent|null|string|undefined'
		);
		/** @type {!goog.soy.data.SanitizedContent|null|string|undefined} */
		var firstOperandValueSelected = soy.asserts.assertType(
			opt_data.firstOperandValueSelected == null ||
				(goog.isString(opt_data.firstOperandValueSelected) ||
					opt_data.firstOperandValueSelected instanceof
						goog.soy.data.SanitizedContent),
			'firstOperandValueSelected',
			opt_data.firstOperandValueSelected,
			'!goog.soy.data.SanitizedContent|null|string|undefined'
		);
		/** @type {!Array<{label: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>|null|undefined} */
		var firstOperandOptions = soy.asserts.assertType(
			opt_data.firstOperandOptions == null ||
				goog.isArray(opt_data.firstOperandOptions),
			'firstOperandOptions',
			opt_data.firstOperandOptions,
			'!Array<{label: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>|null|undefined'
		);
		/** @type {*|null|undefined} */
		...
		var operators = soy.asserts.assertType(
			opt_data.operators == null || goog.isArray(opt_data.operators),
			'operators',
			opt_data.operators,
			'!Array<{name: (!goog.soy.data.SanitizedContent|string), parameterTypes: !Array<!goog.soy.data.SanitizedContent|string>, returnType: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>|null|undefined'
		);
		/** @type {!Array<{label: (!goog.soy.data.SanitizedContent|string), value: (!goog.soy.data.SanitizedContent|string)}>|null|undefined} */
		var roles = soy.asserts.assertType(
			opt_data.roles == null || goog.isArray(opt_data.roles),
		...
		/** @type {!goog.soy.data.SanitizedContent|null|string|undefined} */
		var secondOperandDataType = soy.asserts.assertType(
			opt_data.secondOperandDataType == null ||
				(goog.isString(opt_data.secondOperandDataType) ||
					opt_data.secondOperandDataType instanceof
						goog.soy.data.SanitizedContent),
			'secondOperandDataType',
			opt_data.secondOperandDataType,
			'!goog.soy.data.SanitizedContent|null|string|undefined'
		);
		/** @type {!goog.soy.data.SanitizedContent|null|string|undefined} */
		var secondOperandFieldName = soy.asserts.assertType(
			opt_data.secondOperandFieldName == null ||
				(goog.isString(opt_data.secondOperandFieldName) ||
					opt_data.secondOperandFieldName instanceof
						goog.soy.data.SanitizedContent),
			'secondOperandFieldName',
			opt_data.secondOperandFieldName,
			'!goog.soy.data.SanitizedContent|null|string|undefined'
		);
		/** @type {!goog.soy.data.SanitizedContent|null|string|undefined} */
		var secondOperandType = soy.asserts.assertType(
			opt_data.secondOperandType == null ||
				(goog.isString(opt_data.secondOperandType) ||
					opt_data.secondOperandType instanceof
						goog.soy.data.SanitizedContent),
			'secondOperandType',
			opt_data.secondOperandType,
			'!goog.soy.data.SanitizedContent|null|string|undefined'
		);
		/** @type {*|null|undefined} */
		var secondOperandValue = opt_data.secondOperandValue;
		/** @type {!goog.soy.data.SanitizedContent|null|string|undefined} */
		var selectedOperator = soy.asserts.assertType(
			opt_data.selectedOperator == null ||
				(goog.isString(opt_data.selectedOperator) ||
					opt_data.selectedOperator instanceof
						goog.soy.data.SanitizedContent),
			'selectedOperator',
			opt_data.selectedOperator,
			'!goog.soy.data.SanitizedContent|null|string|undefined'
		);
		...
		incrementalDom.attr(
			'class',
			'form-builder-rule-condition-container timeline-item'
		);
		...
		incrementalDom.text(
			goog.string.unescapeEntities(MSG_EXTERNAL_5099375131746050090)
		);
		incrementalDom.elementClose('span');
		incrementalDom.elementClose('span');
		incrementalDom.elementClose('h4');
		...
		soy.$$getDelegateFn(
			...
			'select',
			false
		)({events: {fieldEdited: _handleFirstOperandFieldEdited}, fixedOptions: fixedOptions, options: fieldOptions, placeholder: '' + msg_19921__soy19922, ref: 'firstOperand' + index, spritemap: spritemap, value: [firstOperandValueSelected]}, null, opt_ijData);
		incrementalDom.elementClose('div');
		$renderConditionOperators(opt_data, null, opt_ijData);
		if (firstOperandType && selectedOperator) {
			if (firstOperandType != 'user') {
				if (binaryOperator) {
					$renderConditionSecondOperandTypeSelector(
						opt_data,
						null,
						opt_ijData
					);
					var fieldHasOptions__soy2527 =
						secondOperandType == 'select' ||
						secondOperandType == 'checkbox_multiple' ||
						secondOperandType == 'radio';
					incrementalDom.elementOpenStart('div');
					incrementalDom.attr(
						'class',
						'condition-type-value form-group-item'
					);
					...
					if (fieldHasOptions__soy2527) {
						...
						soy.$$getDelegateFn(
						...
						)(
							{
								...
								name: secondOperandFieldName,
								options: firstOperandOptions,
								placeholder: '' + msg_19924__soy19925,
								readOnly: readOnly,
								ref: 'secondOperand' + index,
								spritemap: spritemap,
						...
						/** @desc  */
						var MSG_EXTERNAL_1961977818876868209$$2 = Liferay.Language.get(
							'choose-an-option'
						);
						...
						soy.$$getDelegateFn(
						...
						)(
							{
								...
								placeholder: '' + msg_19927__soy19928,
								ref: 'secondOperand' + index,
								spritemap: spritemap,
								value: [secondOperandValue]
							},
		...
		incrementalDom.attr(
			'class',
			'operator panel panel-default panel-inline'
		);
		incrementalDom.elementOpenEnd();
		incrementalDom.elementOpenStart('div');
		...
		if (logicalOperator == 'and') {
			...
			incrementalDom.text(
				goog.string.unescapeEntities(MSG_EXTERNAL_3929281485914893910)
			);
		} else {
			/** @desc  */
			var MSG_EXTERNAL_6627551976444260400 = Liferay.Language.get('or');
			incrementalDom.text(
				goog.string.unescapeEntities(MSG_EXTERNAL_6627551976444260400)
			);
		}
		incrementalDom.elementClose('div');
		incrementalDom.elementClose('div');
		...
		$templateAlias1(
			{
				events: {click: _handleDeleteCondition},
				data: {index: index},
				icon: 'trash',
				monospaced: true,
				ref: 'trashButton' + index,
				size: 'sm',
				spritemap: spritemap,
				style: 'secondary'
			},
	 ...
	 * @suppress {checkTypes}
	 */
	function $renderConditionOperators(
		opt_data,
		opt_ijData,
		...
		soy.$$getDelegateFn(
			...
			'select',
			false
		)({events: {fieldEdited: _handleOperatorEdited}, options: operators, placeholder: '' + msg_19930__soy19931, readOnly: readOnly__soy2623, ref: 'conditionOperator' + index, spritemap: spritemap, value: [selectedOperator]}, null, opt_ijData);
		incrementalDom.elementClose('div');
	}
	...
	if (goog.DEBUG) {
		$renderConditionOperators.soyTemplateName =
			'RuleEditor.renderConditionOperators';
	}
	 ...
	 * @suppress {checkTypes}
	 */
	function $renderConditionSecondOperandTypeSelector(
		opt_data,
		opt_ijData,
		opt_ijData_deprecated
	) {
		...
		/** @desc  */
		var MSG_EXTERNAL_1829736102968854254 = Liferay.Language.get(
			'other-field'
		);
		...
		var options__soy2662 = [
			{label: valueLabel__soy2655, value: 'value'},
			{label: otherFieldLabel__soy2648, value: 'field'}
		];
		var value__soy2664 =
			secondOperandType == 'field'
				...
				? 'value'
				: '';
		var visible__soy2666 =
			selectedOperator && secondOperandType != 'none' ? true : false;
		if (visible__soy2666) {
			...
			soy.$$getDelegateFn(
				...
				{
					events: {fieldEdited: _handleSecondOperandTypeEdited},
					options: options__soy2662,
					placeholder: '' + msg_19939__soy19940,
					ref: 'secondOperandTypeSelector' + index,
					spritemap: spritemap,
					value: [value__soy2664],
					visible: visible__soy2666
				},
				null,
				opt_ijData
			);
	...
	if (goog.DEBUG) {
		$renderConditionSecondOperandTypeSelector.soyTemplateName =
			'RuleEditor.renderConditionSecondOperandTypeSelector';
	}
	 ...
	 * @suppress {checkTypes}
	 */
	function $renderConditionUserRolesSelector(
		opt_data,
		opt_ijData,
		opt_ijData_deprecated
	) {
		...
		incrementalDom.attr(
			'class',
			'condition-user-role form-group-item ' +
				(!visible__soy2696 ? 'hide' : '')
		);
		...
		soy.$$getDelegateFn(
			...
			'select',
			false
		)({events: {fieldEdited: _handleSecondOperandFieldEdited}, options: roles, placeholder: '' + msg_19942__soy19943, spritemap: spritemap, value: [secondOperandValue]}, null, opt_ijData);
		incrementalDom.elementClose('div');
	}
	...
	if (goog.DEBUG) {
		$renderConditionUserRolesSelector.soyTemplateName =
			'RuleEditor.renderConditionUserRolesSelector';
	}
	 ...
	 * @suppress {checkTypes}
	 */
	function $renderConditionLogicalOperatorDropdown(
		opt_data,
		opt_ijData,
		opt_ijData_deprecated
	) {
		...
		var _handleLogicalOperationChange =
			opt_data._handleLogicalOperationChange;
		/** @type {boolean|null|undefined} */
		var enableLogicalOperator = soy.asserts.assertType(
			opt_data.enableLogicalOperator == null ||
				(goog.isBoolean(opt_data.enableLogicalOperator) ||
					opt_data.enableLogicalOperator === 1 ||
					opt_data.enableLogicalOperator === 0),
			'enableLogicalOperator',
			opt_data.enableLogicalOperator,
			'boolean|null|undefined'
		);
		/** @type {!goog.soy.data.SanitizedContent|null|string|undefined} */
		var logicalOperator = soy.asserts.assertType(
		...
		var attributes__soy2721 = function() {
			incrementalDom.attr(
				'class',
				'btn btn-default dropdown-toggle dropdown-toggle-operator text-uppercase'
			);
		...
		incrementalDom.text(
			goog.string.unescapeEntities(MSG_EXTERNAL_6627551976444260400$$1)
		);
		...
		incrementalDom.text(
			goog.string.unescapeEntities(MSG_EXTERNAL_3929281485914893910$$1)
		);
		incrementalDom.elementClose('a');
		incrementalDom.elementClose('li');
		incrementalDom.elementClose('ul');
	...
	if (goog.DEBUG) {
		$renderConditionLogicalOperatorDropdown.soyTemplateName =
			'RuleEditor.renderConditionLogicalOperatorDropdown';
	}
	...
	function $renderHeader(opt_data, opt_ijData, opt_ijData_deprecated) {
		...
		var extraContent = soy.asserts.assertType(
			opt_data.extraContent == null ||
				goog.isFunction(opt_data.extraContent),
			'extraContent',
	...
	function $renderAddItemButton(opt_data, opt_ijData, opt_ijData_deprecated) {
		...
		$templateAlias1(
			{
				events: {click: _handleItemAdded},
				elementClasses: 'rounded-circle',
				icon: 'plus',
				monospaced: true,
				ref: type,
				size: 'sm',
	...
	function $renderAutofill(opt_data, opt_ijData, opt_ijData_deprecated) {
		opt_ijData = opt_ijData_deprecated || opt_ijData;
		/** @type {number} */
		var actionIndex = soy.asserts.assertType(
			goog.isNumber(opt_data.actionIndex),
			'actionIndex',
			opt_data.actionIndex,
			'number'
		);
		/** @type {!goog.soy.data.SanitizedContent|string} */
		var spritemap = soy.asserts.assertType(
		...
		incrementalDom.attr(
			'class',
			'col-md-12 ddm-data-provider-container no-padding'
		);
		incrementalDom.elementOpenEnd();
		if (!actionOutputs || actionOutputs.length == 0) {
			var msg_19948__soy19949 = '';
			/** @desc  */
			var MSG_EXTERNAL_8772116786769251214 = Liferay.Language.get(
				'error'
			);
			msg_19948__soy19949 += MSG_EXTERNAL_8772116786769251214;
			var msg_19945__soy19946 = '';
			/** @desc  */
			var MSG_EXTERNAL_6818430579731669946 = Liferay.Language.get(
				'data-provider-error'
			);
			msg_19945__soy19946 += MSG_EXTERNAL_6818430579731669946;
			$templateAlias4(
				{
					message: '' + msg_19945__soy19946,
					spritemap: spritemap,
					style: 'danger',
					title: '' + msg_19948__soy19949
				},
				null,
				opt_ijData
			);
		...
		if (
			...
			incrementalDom.attr(
				'class',
				'data-provider-parameter-input-container'
			);
			incrementalDom.elementOpenEnd();
			if (hasRequiredInputs) {
				...
				incrementalDom.attr(
					'class',
					'data-provider-parameter-input-required-field'
				);
				incrementalDom.elementOpenEnd();
				/** @desc  */
				var MSG_EXTERNAL_6811624707113510241 = Liferay.Language.get(
					'required-field'
				);
				incrementalDom.text(
					goog.string.unescapeEntities(
						MSG_EXTERNAL_6811624707113510241
					)
				);
				...
				incrementalDom.elementOpenEnd();
				$templateAlias5(
					{spritemap: spritemap, symbol: 'asterisk'},
					null,
					opt_ijData
				);
				incrementalDom.elementClose('span');
			...
			/** @desc  */
			var MSG_EXTERNAL_3371778164350296990 = Liferay.Language.get(
				'data-provider-parameter-input'
			);
			incrementalDom.text(
				goog.string.unescapeEntities(MSG_EXTERNAL_3371778164350296990)
			);
			...
			incrementalDom.elementOpenEnd();
			/** @desc  */
			var MSG_EXTERNAL_8269265529940927663 = Liferay.Language.get(
				'data-provider-parameter-input-description'
			);
			incrementalDom.text(
				goog.string.unescapeEntities(MSG_EXTERNAL_8269265529940927663)
			);
			incrementalDom.elementClose('p');
			incrementalDom.elementClose('div');
			incrementalDom.elementOpenStart('div');
			incrementalDom.attr(
				'class',
				'data-provider-parameter-input-list row'
			);
			incrementalDom.elementOpenEnd();
			var input2865List = actionInputs;
			var input2865ListLen = input2865List.length;
			for (
				var input2865Index = 0;
				input2865Index < input2865ListLen;
				input2865Index++
			) {
				...
				incrementalDom.attr(
					'class',
					'col-md-9 container-input-field container-input-field-' +
						index__soy2846
				);
				incrementalDom.attr(
					'container-input-field-index',
					index__soy2846
				);
				incrementalDom.elementOpenEnd();
				soy.$$getDelegateFn(
					...
					{
						events: {fieldEdited: _handleDataProviderInputEdited},
						options: input2865Data.fieldOptions,
						placeholder: '' + msg_19951__soy19952,
						ref:
							'action' +
							actionIndex +
							'dataProviderInput' +
		...
		if (actionOutputs && actionOutputs.length > 0) {
			...
			incrementalDom.attr(
				'class',
				'data-provider-parameter-output-container'
			);
			incrementalDom.elementOpenEnd();
			incrementalDom.elementOpenStart('div');
			incrementalDom.attr('class', 'data-provider-label-container');
			...
			incrementalDom.elementOpen('b');
			/** @desc  */
			var MSG_EXTERNAL_4821762715526155474 = Liferay.Language.get(
				'data-provider-parameter-output'
			);
			incrementalDom.text(
				goog.string.unescapeEntities(MSG_EXTERNAL_4821762715526155474)
			);
			incrementalDom.elementClose('b');
			incrementalDom.elementClose('p');
			incrementalDom.elementOpenStart('p');
			...
			incrementalDom.elementOpenEnd();
			/** @desc  */
			var MSG_EXTERNAL_1855554600739008989 = Liferay.Language.get(
				'data-provider-parameter-output-description'
			);
			incrementalDom.text(
				goog.string.unescapeEntities(MSG_EXTERNAL_1855554600739008989)
			);
			incrementalDom.elementClose('p');
			incrementalDom.elementClose('div');
			incrementalDom.elementOpenStart('div');
			incrementalDom.attr(
				'class',
				'data-provider-parameter-output-list row'
			);
			incrementalDom.elementOpenEnd();
			var output2902List = actionOutputs;
			var output2902ListLen = output2902List.length;
			for (
				var output2902Index = 0;
				output2902Index < output2902ListLen;
				output2902Index++
			) {
				...
				incrementalDom.attr(
					'class',
					'col-md-9 container-output-field container-output-field-' +
						index__soy2883
				);
				incrementalDom.attr(
					'container-output-field-index',
					index__soy2883
				);
				incrementalDom.elementOpenEnd();
				soy.$$getDelegateFn(
					...
					{
						events: {fieldEdited: _handleDataProviderOutputEdited},
						options: output2902Data.fieldOptions,
						placeholder: '' + msg_19954__soy19955,
						ref:
							'action' +
							actionIndex +
							'dataProviderOutput' +
	...
	exports.render.params = [
		...
		'_handleDataProviderInputEdited',
		'_handleDataProviderOutputEdited',
		'_handleDeleteAction',
		'_handleDeleteCondition',
		'_handleEditExpression',
		'_handleFirstOperandFieldEdited',
		'_handleLogicalOperationChange',
		'_handleOperatorEdited',
		'_handleRuleAdded',
		'_handleSecondOperandFieldEdited',
		'_handleSecondOperandTypeEdited',
		'_handleSecondOperandValueEdited',
		'_handleTargetSelection',
	...
	exports.render.types = {
		...
		readOnly: 'bool',
		spritemap: 'string',
		_handleActionSelection: 'any',
		_handleActionAdded: 'any',
		_handleCancelRule: 'any',
		_handleConditionAdded: 'any',
		_handleDataProviderInputEdited: 'any',
		_handleDataProviderOutputEdited: 'any',
		_handleDeleteAction: 'any',
		_handleDeleteCondition: 'any',
		_handleEditExpression: 'any',
		_handleFirstOperandFieldEdited: 'any',
		_handleLogicalOperationChange: 'any',
		_handleOperatorEdited: 'any',
		_handleRuleAdded: 'any',
		_handleSecondOperandFieldEdited: 'any',
		_handleSecondOperandTypeEdited: 'any',
		_handleSecondOperandValueEdited: 'any',
		_handleTargetSelection: 'any',
		_handleModalButtonClicked: 'any',
		roles: 'list<[\n\t\tlabel: string,\n\t\tvalue: string\n\t]>'
	};
	exports.renderModal.params = [
		'question',
		'title',
		'type',
		'spritemap',
	...
	exports.renderActionTarget.params = [
		'index',
		'options',
		'ref',
		'spritemap',
	...
	exports.renderActionTarget.types = {
		index: 'int',
		options: 'any',
		ref: 'string',
		spritemap: 'string',
	...
	exports.renderCondition.types = {
		...
		firstOperandValueSelected: 'string',
		firstOperandOptions:
			'list<[\n\t\tlabel: string,\n\t\tvalue: string\n\t]>',
		fixedOptions: 'any',
		logicalOperator: 'string',
		...
		secondOperandFieldName: 'string',
		secondOperandType: 'string',
		secondOperandValue: 'any',
		selectedOperator: 'string'
	};
	exports.renderConditionOperators.params = [
		'index',
		'spritemap',
		'_handleOperatorEdited',
		'firstOperandType',
	...
	exports.renderConditionOperators.types = {
		index: 'int',
		spritemap: 'string',
		_handleOperatorEdited: 'any',
		firstOperandType: 'string',
	...
	exports.renderConditionSecondOperandTypeSelector.params = [
		'index',
		'spritemap',
		'_handleSecondOperandTypeEdited',
		'secondOperandType',
	...
	exports.renderConditionSecondOperandTypeSelector.types = {
		index: 'int',
		spritemap: 'string',
		_handleSecondOperandTypeEdited: 'any',
		secondOperandType: 'string',
	...
	exports.renderConditionUserRolesSelector.params = [
		'index',
		'spritemap',
		'_handleSecondOperandFieldEdited',
		'roles',
	...
	exports.renderConditionUserRolesSelector.types = {
		index: 'int',
		spritemap: 'string',
		_handleSecondOperandFieldEdited: 'any',
		roles: 'list<[\n\t\t\tlabel: string,\n\t\t\tvalue: string\n\t\t]>\n\t',
	...
	exports.renderConditionLogicalOperatorDropdown.params = [
		'_handleLogicalOperationChange',
		'enableLogicalOperator',
		'logicalOperator'
	];
	exports.renderConditionLogicalOperatorDropdown.types = {
		_handleLogicalOperationChange: 'any',
		enableLogicalOperator: 'bool',
		logicalOperator: 'string'
	};
	exports.renderHeader.params = ['title', 'extraContent'];
	exports.renderHeader.types = {title: 'string', extraContent: 'html'};
	exports.renderAddItemButton.params = [
		'_handleItemAdded',
		'spritemap',
		'type'
	];
	exports.renderAddItemButton.types = {
		_handleItemAdded: 'any',
		spritemap: 'string',
		type: 'string'
	};
	exports.renderAutofill.params = [
		'actionIndex',
		'spritemap',
		'_handleDataProviderInputEdited',
		'_handleDataProviderOutputEdited',
