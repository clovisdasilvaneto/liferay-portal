...
var $render = function(opt_data, opt_ijData, opt_ijData_deprecated) {
  ...
  $field_settings_toolbar_list({options: toolbarTemplateContext.options}, opt_ijData);
...
/**
 * @param {$field_settings_toolbar_list.Params} opt_data
 * @param {Object<string, *>=} opt_ijData
 * @param {Object<string, *>=} opt_ijData_deprecated
 * @return {void}
 * @suppress {checkTypes|uselessCode}
 */
var $field_settings_toolbar_list = function(opt_data, opt_ijData, opt_ijData_deprecated) {
  opt_ijData = opt_ijData_deprecated || opt_ijData;
  ...
  incrementalDom.elementOpenEnd();
  var option663List = options;
  var option663ListLen = option663List.length;
  for (var option663Index = 0; option663Index < option663ListLen; option663Index++) {
    var option663Data = option663List[option663Index];
    $field_settings_toolbar_item({option: option663Data}, opt_ijData);
  }
  incrementalDom.elementClose('div');
};
...
/**
 * @param {$field_settings_toolbar_item.Params} opt_data
 * @param {Object<string, *>=} opt_ijData
 * @param {Object<string, *>=} opt_ijData_deprecated
 * @return {void}
 * @suppress {checkTypes|uselessCode}
 */
var $field_settings_toolbar_item = function(opt_data, opt_ijData, opt_ijData_deprecated) {
  opt_ijData = opt_ijData_deprecated || opt_ijData;
  ...
  incrementalDom.elementOpenStart('a');
      incrementalDom.attr('class', 'ddm-form-field-actions-item dropdown-item ' + (option.buttonClass || ''));
