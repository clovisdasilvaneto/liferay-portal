...
goog.loadModule(function(exports) {
	 ...
	 * @suppress {checkTypes}
	 */
	function __deltemplate_s1384_afe07ef6(
		opt_data,
		opt_ijData,
		...
		soy.$$getDelegateFn(
			...
			'wizard',
			false
		)({activePage: activePage, pageIndex: pageIndex, paginationMode: 'wizard', spritemap: spritemap, total: total, _handleFieldBlurred: _handleFieldBlurred, _handleFieldClicked: _handleFieldClicked, _handleFieldEdited: _handleFieldEdited, editable: editable, empty: empty, page: page}, null, opt_ijData);
	}
	...
	if (goog.DEBUG) {
		__deltemplate_s1384_afe07ef6.soyTemplateName =
			'PaginatedPageRenderer.__deltemplate_s1384_afe07ef6';
	}
	soy.$$registerDelegateFn(
		soy.$$getDelTemplateId('PageRenderer.container.idom'),
		'paginated',
		0,
		__deltemplate_s1384_afe07ef6
	);
