...
var $render = function(opt_data, opt_ijData, opt_ijData_deprecated) {
  ...
  incrementalDom.elementOpenStart('div');
      incrementalDom.attr('class', 'ddm-calculator-component');
  ...
  incrementalDom.elementClose('li');
  incrementalDom.elementOpenStart('li');
      incrementalDom.attr('class', 'border-top-right btn btn-secondary calculator-button');
      incrementalDom.attr('data-calculator-key', ')');
  incrementalDom.elementOpenEnd();
  incrementalDom.text(')');
  incrementalDom.elementClose('li');
  ...
  incrementalDom.elementClose('li');
  incrementalDom.elementOpenStart('li');
      incrementalDom.attr('class', 'border-bottom-left btn btn-secondary button-two-columns calculator-button');
      incrementalDom.attr('data-calculator-key', '0');
  incrementalDom.elementOpenEnd();
  incrementalDom.text('0');
  incrementalDom.elementClose('li');
  incrementalDom.elementOpenStart('li');
      incrementalDom.attr('class', 'border-bottom-right btn btn-secondary calculator-button');
      incrementalDom.attr('data-calculator-key', '.');
  incrementalDom.elementOpenEnd();
  incrementalDom.text('.');
  incrementalDom.elementClose('li');
  ...
  incrementalDom.elementClose('li');
  incrementalDom.elementOpenStart('li');
      incrementalDom.attr('class', 'border-bottom-left border-bottom-right btn btn-secondary calculator-button');
      incrementalDom.attr('data-calculator-key', '/');
  incrementalDom.elementOpenEnd();
  incrementalDom.text('/');
  incrementalDom.elementClose('li');
