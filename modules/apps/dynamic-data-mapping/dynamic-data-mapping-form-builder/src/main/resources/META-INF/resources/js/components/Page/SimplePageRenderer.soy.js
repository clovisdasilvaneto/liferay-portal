...
goog.loadModule(function(exports) {
	 ...
	 * @suppress {checkTypes}
	 */
	function __deltemplate_s1411_2444dc78(
		opt_data,
		opt_ijData,
	...
	if (goog.DEBUG) {
		__deltemplate_s1411_2444dc78.soyTemplateName =
			'ListPageRenderer.__deltemplate_s1411_2444dc78';
	}
	soy.$$registerDelegateFn(
		soy.$$getDelTemplateId('PageRenderer.container.idom'),
		'simple',
		0,
		__deltemplate_s1411_2444dc78
	);
	 ...
	 * @suppress {checkTypes}
	 */
	function __deltemplate_s1442_ea9f5e32(
		opt_data,
		opt_ijData,
		opt_ijData_deprecated
	) {
	...
	if (goog.DEBUG) {
		__deltemplate_s1442_ea9f5e32.soyTemplateName =
			'ListPageRenderer.__deltemplate_s1442_ea9f5e32';
	}
	soy.$$registerDelegateFn(
		soy.$$getDelTemplateId('PageRenderer.page.idom'),
		'simple',
		0,
		__deltemplate_s1442_ea9f5e32
	);
	 ...
	 * @suppress {checkTypes}
	 */
	function __deltemplate_s1467_ab801acd(
		opt_data,
		opt_ijData,
		opt_ijData_deprecated
	) {
		...
		for (
			var column1492Index = 0;
			column1492Index < column1492ListLen;
			column1492Index++
		) {
			...
			soy.$$getDelegateFn(
			...
			)(
				{
					...
					_handleFieldClicked: _handleFieldClicked,
					_handleFieldEdited: _handleFieldEdited,
					column: column1492Data,
					columnIndex: column1492Index,
					key: column1492Index,
					editable: editable,
					pageIndex: pageIndex,
					rowIndex: rowIndex,
	...
	if (goog.DEBUG) {
		__deltemplate_s1467_ab801acd.soyTemplateName =
			'ListPageRenderer.__deltemplate_s1467_ab801acd';
	}
	soy.$$registerDelegateFn(
		soy.$$getDelTemplateId('PageRenderer.row.idom'),
		'simple',
		0,
		__deltemplate_s1467_ab801acd
	);
	 ...
	 * @suppress {checkTypes}
	 */
	function __deltemplate_s1495_ccd3f195(
		opt_data,
		opt_ijData,
		opt_ijData_deprecated
	) {
		...
		if (column.fields.length != 0) {
			...
			for (
				var field1527Index = 0;
				field1527Index < field1527ListLen;
				field1527Index++
			) {
				var field1527Data = field1527List[field1527Index];
				var fieldType__soy1518 =
					($$temp = field1527Data.type) == null ? 'empty' : $$temp;
				soy.$$getDelegateFn(
	...
	if (goog.DEBUG) {
		__deltemplate_s1495_ccd3f195.soyTemplateName =
			'ListPageRenderer.__deltemplate_s1495_ccd3f195';
	}
	soy.$$registerDelegateFn(
		soy.$$getDelTemplateId('PageRenderer.column.idom'),
		'simple',
		0,
		__deltemplate_s1495_ccd3f195
	);
