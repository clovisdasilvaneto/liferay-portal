...
goog.loadModule(function(exports) {
	 ...
	 * @suppress {checkTypes}
	 */
	function __deltemplate_s1715_22101879(
		opt_data,
		opt_ijData,
		...
		if (activePage == pageIndex) {
			...
			soy.$$getDelegateFn(
				...
				soy.$$assignDefaults(
					{
						description:
							($$temp = page.description) == null ? '' : $$temp,
						pageIndex: pageIndex,
	...
	if (goog.DEBUG) {
		__deltemplate_s1715_22101879.soyTemplateName =
			'WizardPageRenderer.__deltemplate_s1715_22101879';
	}
	soy.$$registerDelegateFn(
		soy.$$getDelTemplateId('PageRenderer.container.idom'),
		'wizard',
		0,
		__deltemplate_s1715_22101879
	);
	 ...
	 * @suppress {checkTypes}
	 */
	function __deltemplate_s1750_2c8f81b2(
		opt_data,
		opt_ijData,
		opt_ijData_deprecated
	) {
		...
		if (empty) {
			var attributes__soy1765 = function() {
				incrementalDom.attr(
					'class',
					'col col-empty col-md-12 last-col lfr-initial-col mt-5 mb-4'
				);
			...
			incrementalDom.elementOpenEnd();
			/** @desc  */
			var MSG_EXTERNAL_3366078975712358322 = Liferay.Language.get(
				'drag-from-sidebar-and-drop-here'
			);
			incrementalDom.text(
				goog.string.unescapeEntities(MSG_EXTERNAL_3366078975712358322)
			);
			incrementalDom.elementClose('div');
			incrementalDom.elementClose('div');
			incrementalDom.elementClose('div');
	...
	if (goog.DEBUG) {
		__deltemplate_s1750_2c8f81b2.soyTemplateName =
			'WizardPageRenderer.__deltemplate_s1750_2c8f81b2';
	}
	soy.$$registerDelegateFn(
		soy.$$getDelTemplateId('PageRenderer.page.idom'),
		'wizard',
		0,
		__deltemplate_s1750_2c8f81b2
	);
	 ...
	 * @suppress {checkTypes}
	 */
	function __deltemplate_s1814_6cf9e12f(
		opt_data,
		opt_ijData,
		opt_ijData_deprecated
	) {
		...
		for (
			var column1838Index = 0;
			column1838Index < column1838ListLen;
			column1838Index++
		) {
	...
	if (goog.DEBUG) {
		__deltemplate_s1814_6cf9e12f.soyTemplateName =
			'WizardPageRenderer.__deltemplate_s1814_6cf9e12f';
	}
	soy.$$registerDelegateFn(
		soy.$$getDelTemplateId('PageRenderer.row.idom'),
		'wizard',
		0,
		__deltemplate_s1814_6cf9e12f
	);
	 ...
	 * @suppress {checkTypes}
	 */
	function __deltemplate_s1841_820f2a00(
		opt_data,
		opt_ijData,
		opt_ijData_deprecated
	) {
		...
		if (column.fields.length != 0) {
			...
			var content__soy1885 = function() {
				...
				for (
					var field1896Index = 0;
					field1896Index < field1896ListLen;
					field1896Index++
				) {
	...
	if (goog.DEBUG) {
		__deltemplate_s1841_820f2a00.soyTemplateName =
			'WizardPageRenderer.__deltemplate_s1841_820f2a00';
	}
	soy.$$registerDelegateFn(
		soy.$$getDelTemplateId('PageRenderer.column.idom'),
		'wizard',
		0,
		__deltemplate_s1841_820f2a00
	);
